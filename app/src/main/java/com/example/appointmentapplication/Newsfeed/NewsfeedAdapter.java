...
public class NewsfeedAdapter extends RecyclerView.Adapter<NewsfeedAdapter.ViewHolder> {
    ...
    public NewsfeedAdapter(Context context, ArrayList<modelClass> modelClassArrayList) {
    ...
    public NewsfeedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.newsfeed_layout_item,null,false);
