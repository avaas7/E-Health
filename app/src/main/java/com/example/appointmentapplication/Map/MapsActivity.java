package com.example.appointmentapplication.Map;
...
*/
   ...
   */ }
    ...
    {
        MarkerOptions markerOptions = new MarkerOptions().position(markerLatLng).snippet(tel).title(markerTitle).icon(BitmapFromVector(getApplicationContext(),R.drawable.ic_hospital));
        mGoogleMap.addMarker(markerOptions);
